...
public record PokemonDTO(
    ...
    public record PokemonDTO_AllStats(PokemonDTO_StatInfo hp, PokemonDTO_StatInfo atk, PokemonDTO_StatInfo def,
            PokemonDTO_StatInfo spa, PokemonDTO_StatInfo spd, PokemonDTO_StatInfo spe) {
    }
    ...
    public record PokemonDTO_MoveInfo(String apiName, String displayName, String damageClass, int power, int accuracy,
            int pp) {
    }
}
